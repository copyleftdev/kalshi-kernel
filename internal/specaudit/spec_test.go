...
func TestCuratedMCPSurfaceAlignsWithUpstreamOperationsAndChannels(t *testing.T) {
	...
	wantTools := []string{"amend_order", "cancel_order", "get_candles", "get_last", "get_market", "get_orderbook", "get_portfolio", "get_trades", "kernel_status", "place_order", "search_markets"}
	var gotTools []string
